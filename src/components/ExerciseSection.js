...
const ExerciseSection = ({ exercises, searchTerm, setSearchTerm }) => {
  return (
    // Добавлен id="exercises" для якорной ссылки и pt-20 для отступа под Navbar
    <div id="exercises" className="min-h-screen py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-gray-900 to-gray-800 dark:from-gray-800 dark:to-gray-900 pt-20"> {/* Добавлен pt-20 */}
      <div className="max-w-7xl mx-auto">
        {/* Убран pt-10, добавлен pt-20 к родительскому div */}
        <motion.div
